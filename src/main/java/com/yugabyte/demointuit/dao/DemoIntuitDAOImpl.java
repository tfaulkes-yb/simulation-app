...
import com.yugabyte.demointuit.util.GeneralUtility;
...
@Repository
public class DemoIntuitDAOImpl implements DemoIntuitDAO{
    @Autowired
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DemoIntuitDAOImpl.class);
